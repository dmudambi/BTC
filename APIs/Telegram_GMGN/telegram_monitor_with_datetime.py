...
class ATHPriceParser(BaseMessageParser):
    def parse_message(self, message):
        ...
        message_data['message_timestamp'] = message.date.strftime("%Y-%m-%d %H:%M:%S")
