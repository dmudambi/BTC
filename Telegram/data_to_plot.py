...
# Token Monitoring
NUM_RECENT_TOKENS = 150     # Number of most recent tokens to monitor
LOOKBACK_HOURS = 72       # Hours to look back for token history

# Timeframe Settings
VALID_TIMEFRAMES = ['1m', '3m', '5m', '15m', '30m', '1H', '2H', '4H', '1D']
DEFAULT_TIMEFRAMES = ['1m', '5m', '15m', '1H']  # Default timeframes to monitor

# Chart Parameters
VOLUME_THRESHOLD = 5      # Minimum volume multiple to consider significant
VOLUME_MA_PERIOD = 5      # Period for volume moving average
MIN_BREAKOUT_PERCENT = 20 # Minimum percentage for breakout detection
...
def create_token_plot(df: pd.DataFrame, timeframe: str, token_name: str, token_info: dict, lookback_candles: int = 4) -> go.Figure:
