...
# Filters for new tokens - PRE COLLECTION
...
print(f"Token Launch Liquidity Filter: {Master_Functions.format_number(new_token_liquidity_filter)}")
...
print(f"Timeframes being used to retrieve OHLCV data: {', '.join(timeframes)}")
